...
- [@hankchn](https://github.com/hankchn) — 需求 & 测试
- [CodeBuddy (Claude)](https://www.codebuddy.ai) — 开发 & 封装
...
```bash
npx skills add hankchn/auto-checkin-cordcloud -g -y
```

### 方式二：手动安装

```bash
git clone https://github.com/hankchn/auto-checkin-cordcloud.git ~/.codebuddy/skills/auto-checkin-cordcloud
```
